classdef hybridAStar_CarTrailer_test < handle
    ...
    methods
        ...
        function obj = hybridAStar_CarTrailer_test(CarLength, CarWidth, WheelBase, ...
            ...
            obj.StartPoint = [4, 14, pi, pi];
            obj.GoalPoint = [4.5, 13, pi, pi];
            obj.MapDimX = 20;
            obj.MapDimY = 20;
            obj.Obstacle = [];
            obj.TickXY = 0.5;
                    ...
                    if m(1) > 0 && m(1) <= obj.MapDimX && m(2) > 0 && m(2) <= obj.MapDimY && abs(obj.roundAngle(m(4)-m(3)))<= 45/180*pi
                        ...
                        if ~obj.checkTrailer(m(1), m(2), m(4)) && ~obj.checkCar(m(1), m(2), m(3))
                            ...
                            if ~isempty(id)
                                ...
                                obj.drawCar(h, m(1), m(2), m(3), steering);
                                obj.drawTrailer(h, m(1), m(2), m(3), m(4));
