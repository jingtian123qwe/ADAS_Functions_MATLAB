classdef hybridAStar_Trailer < handle
    ...
    methods
        ...
        function obj = hybridAStar_Trailer(CarLength, CarWidth, WheelBase, ...
                WheelTrack, TrailerBase, TrailerTrack)
            if nargin == 6
    ...
    methods (Access = private)
        ...
        function drawTrailer(obj, h, x, y, theta)
            ...
            wl = obj.changePos(x, y, theta, wl);
            wr = obj.changePos(x, y, theta, wr);
        ...
        function status = checkTrailer_Test(obj, x, y, theta)
