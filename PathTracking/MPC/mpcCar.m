...
Ts = 0.02;
[Ad,Bd,Cd,Dd,U,Y,X,DX] = VehicleModelDT(Ts,x0,u0);
...
mpcobj.PredictionHorizon = 50;%25;
...
mpcobj.Weights.OutputVariables = [0.2 30 0 1];
...
for k = 1:length(T)
    ...
    [Ad,Bd,Cd,Dd,U,Y,X,DX] = VehicleModelDT(Ts,x,u);
